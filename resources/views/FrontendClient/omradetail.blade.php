...
<div class="header-left" style="
    ...
    <h1 style="margin-left: 1003px;">{{ $omra->titre }}2023</h1>
    ...
    <div class="row" style=" float: none; padding: 29px;margin-right: 70px; margin-bottom:20px; margin-left:8%;">
        <div class="column" style="background-color:white;box-shadow: 2px 2px 13px rgba(0, 0, 0, 0.1);">
            ...
            <img src="{{asset('omra')}}/{{$omra->image}}" alt="Image" style="width: 100%;height: 100%;">

            <!-- <p>Some text..</p> -->
        </div>
        <div class="column" style="background-color:white;box-shadow: 2px 2px 13px rgba(0, 0, 0, 0.1);">
            <h2>Description</h2></br>
            <p style=" text-align: justify;text-justify: inter-word;">{{ $omra->description }}</p>
            <div class="reservation" style="margin-left: 457px;margin-top: 256px;">
                <ul>
                    <li class="span1_of_3">
                        <div class="date_btn">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal" style="margin-top: -30%;">Réserver</button>
                            <input type="hidden" value="{{$omra->id}}" name="id_res">
                        </div>
                    </li>
                    <div class="clearfix"></div>
                </ul>
            </div>
            @if($omra->nb_disponible == 0)
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h4 class="modal-title">Réserver {{$omra->titre}}</h4>
            ...
            <div class="modal" id="myModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <!-- Modal body -->
                        <div class="modal-body">
                            <form method="POST" action="{{route('reserve-omra.store')}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <input type="hidden" value="{{$omra->id}}" name="omra_id">
                                    <input type="hidden" value="{{ $omra->nb_personne }}" name="omra_nb">


                                    <?php
                                    $count = App\Models\ResevationOmra::where('omra_id', $omra->id)->count();

                                    $nb_disponible = $omra->nb_personne - $count;
    ...
    <!-- <div class="col-md-8 banner-right" style="
    width: 90%;
    margin-bottom: 20px;
    margin-right: 17px;
"> -->
