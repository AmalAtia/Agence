                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="middle" style="width: 250px;margin-left: -30px;">
                                <div id="mult_range">
                                    <span id="left_valu">200</span><span> ~ </span><span id="right_valu">1600</span>
                                </div>
                                <div class="multi-range-slider my-2">
                                    <input type="range" id="input_lef" class="rang_slider" min="0"
                                        max="1000" value="200" onmousemove="left_slider(this.value)">
                                    <input type="range" id="input_righ" class="range_slider" min="0"
                                        max="2000" value="1600" onmousemove="right_slider(this.value)">
                                    <div class="slider">
                                        <div class="track"
                                            style="
