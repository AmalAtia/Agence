  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:#FFF; color:black;padding-top:9%;">
      ...
      <ul class="nav" style="padding:5%;">
        ...
        <li class="nav-item menu-items <?php if ($page == 'acceuil.index') {
                                          echo 'active';
                                        } ?>">
          <a class="nav-link" href="{{ route('acceuil.index')}}">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> @can('arrangement-list')<a class="nav-item" style="color:grey;" href="{{ route('arrangement.index')}}">Arrangement</a>@endcan</li>
              <li class="nav-item"> @can('supplement-list')<a class="nav-item" style="color:grey;" href="{{ route('supplement.index')}}">Supplement</a>@endcan</li>
            </ul>
          </div>
        </li>
        <!-- <li class="nav-item menu-items">
        ...
        <li class="nav-item menu-items">
          ...
          <a class="nav-link" href="{{ route('circuit.index')}}">
            ...
            <span class="menu-title">Circuit</span>
          </a>
          @endcan
        </li>
        <li class="nav-item menu-items">
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown" style="background-color:white;">
                <h6 class="p-3 mb-0" style="color:grey;"><a href="{{route('profileAdmin.index')}}">Profile</a></h6>
